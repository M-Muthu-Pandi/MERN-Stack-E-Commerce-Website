...
const SignInGoogle = () => {
    ...
    return (
        <>
            ...
            {/* Google SignIn */}
            <button onClick={handleSignIn} className="bg-blue-600 rounded-md p-1 text-sm text-white hover:bg-blue-700 flex justify-between items-center gap-2 font-medium">
