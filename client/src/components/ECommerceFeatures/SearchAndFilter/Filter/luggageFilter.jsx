...
const LuggageFilter = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://mu2-infinity-mern-stack-e-commerce.onrender.com/api/luggages")
      .then((res) => {
  ...
  const handleRemoveProduct = async (id) => {
    try {
      await axios.delete(`https://mu2-infinity-mern-stack-e-commerce.onrender.com/api/luggages/${id}`);
